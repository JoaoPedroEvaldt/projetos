      ...
      <?php foreach ($listaEstudantes as $estudante) { ?>
        <tr>
          ...
          <td> <?php echo $estudante["idade"]; ?> </td>
            <td> <a href="/<?php echo FOLDER; ?>/?controller=Estudante&acao=editar&id=<?php echo $estudante['id'];?>"class="btn btn-primary">Editar</a> 
             <a href="/<?php echo FOLDER; ?>/?controller=Estudante&acao=excluir&id=<?php echo $estudante['id'];?>"class="btn btn-primary">Excluir</a> </td>
