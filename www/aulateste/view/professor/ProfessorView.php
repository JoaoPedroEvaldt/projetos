      ...
      <?php foreach ($listaProfessores as $professor) { ?>
        <tr>
          ...
          <td> <?php echo $professor["idade"]; ?> </td>
            <td> <a href="/<?php echo FOLDER; ?>/?controller=Professor&acao=editar&id=<?php echo $professor['id'];?>"class="btn btn-primary">Editar</a> 
             <a href="/<?php echo FOLDER; ?>/?controller=Professor&acao=excluir&id=<?php echo $professor['id'];?>"class="btn btn-primary">Excluir</a> </td>
